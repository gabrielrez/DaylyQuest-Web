        ...
        <div class="flex-1 p-10 overflow-y-auto">
            ...
            <div class="flex flex-col gap-4 mt-8">
                ...
                <ul class="flex gap-8">
                    ...
                    <li data-language="Portuguese" class="hover:scale-110 cursor-pointer transition-all duration-200 ease-in-out">
                        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 32 32">
                    ...
                    <li data-language="Spanish" class="hover:scale-110 cursor-pointer transition-all duration-200 ease-in-out">
                        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 32 32">

    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 p-10 overflow-y-auto">
            ...
            <div class="flex flex-col gap-4 mt-8">
                ...
                <ul class="flex flex-col gap-y-4 mt-5 underline text-text_gray">
                ...
                <p class="text-base text-text_gray mt-5"><span class="font-bold italic">DaylyQuest © 2025. Some Rights Reserved.</span>
                    <br>
                    <br>
                    <span class="font-bold italic">Tax ID:</span> 11.111.111/1111-11
                    <br>
                    <span class="font-bold italic">Address:</span> Rua Nome Rua, 111, 11th floor, Suite 1111 - Bairro - City - State - ZIP Code: 11111-111
                </p>
            </div>
        </div>
    </div>

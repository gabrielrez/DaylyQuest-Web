            ...
            <div class="w-full max-w-[680px] mt-8 flex gap-10">
                <form action="/user/{{ Auth::user()->id }}" method="POST" class="flex flex-col items-center gap-5 w-full" enctype="multipart/form-data">
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" name="nickname" placeholder="Nickname" class="input-field font-roboto bg-bg_gray border border-2 border-detail mt-2 px-6 w-full text-white" value="{{ Auth::user()->nickname }}" required />
                    </div>
                    <button type="submit"

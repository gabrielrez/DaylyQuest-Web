                ...
                <div class="text-3xl">
                    <div class="flex items-center gap-8">
                        ...
                        <div class="flex flex-col font-poppins">
                            ...
                            <p class="text-base mt-4 max-w-[800px] text-text_gray font-roboto">{{ Auth::user()->bio }}</p>
                            <a href="/profile/edit" class="text-base text-text_gray font-roboto mt-3 underline">Edit Profile</a>
                        </div>
                    </div>
                </div>
            </div>

<x-layouts.layout-lp>
    ...
    <section class="mt-20">
        <div class="grid grid-cols-2 gap-10 items-center">
            <img class="mt-12 border-2 border-detail rounded-2xl shadow-2xl transition-all duration-200 ease-in-out" src="<?= asset('images/collections-lp.png') ?>" alt="DaylyQuest collections interface">
            <div class="flex flex-col">
                ...
                <p class="mt-6 text-white text-lg font-roboto">

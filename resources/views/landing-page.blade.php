<x-layouts.layout-lp>
    <header class="my-8 block md:flex items-center justify-between">
        <h1 class="text-3xl font-poppins font-bold cursor-default text-center">
            <span class="text-primary">Dayly</span><span class="text-secondary">Quest</span>
        </h1>
        <div class="flex gap-3 justify-center mt-8 md:mt-0">
    ...
    <section id="hover-section" class="mt-10 sm:mt-20 flex flex-col gap-10 lg:flex-row items-center">
        <div class="lg:w-1/2">
            <h1 class="text-white text-center lg:text-left text-3xl sm:text-6xl font-poppins font-semibold leading-tight">Level up <br>your <span class="underline-secondary">productivity</span /> <br><span class="underline-secondary">and discipline</span></h1>
            <p class="text-text_gray text-center lg:text-left text-base sm:text-xl mt-3 sm:mt-8">DaylyQuest helps you organize and achieve your goals with ease. Create custom collections, set deadlines, and track your progress. Make each day a quest toward your best self.</p>
        </div>
        <div class="lg:w-1/2">
    ...
    <section class="mt-20 md:mt-40">
        <div class="flex flex-col">
            <h1 class="text-white text-center text-xl sm:text-4xl font-poppins font-semibold leading-tight underline-secondary">Organize your most different goals<span class="text-secondary">!</span></h1>
            ...
            <a href="/register" class="self-center mt-10 text-center font-poppins font-bold bg-primary px-10 sm:px-20 py-2.5 shadow-xl rounded-lg hover:scale-95 transition-all duration-200 ease-in-out">Start Right Now!</a>

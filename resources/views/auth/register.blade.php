...
<body class="bg-bg_black mx-auto px-5 sm:px-10">
    <section class="flex flex-col h-screen justify-center">
        ...
        <form action="/register" method="POST" class="flex flex-col items-center gap-5 w-full mt-8">
            ...
            <select name="timezone" class="input-field font-roboto bg-bg_gray border-2 border-detail px-6 w-full text-white" required>
                <option value="" disabled {{ old('timezone') ? '' : 'selected' }}>Select Your Timezone</option>

<div id="side-menu" class="fixed left-0 top-0 z-40 w-full bg-bg_black h-full border-r-2 border-bg_gray shadow-lg transform-translate-x-full transition-transform duration-300 ease-in-out">
    <div class="p-5">

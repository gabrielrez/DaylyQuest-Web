<div class="w-1/6 bg-bg_gray p-6 m-8 rounded-3xl shadow-md sticky top-0">
    ...
    <nav class="mt-8 flex flex-col gap-y-8 text-xl items-center font-poppins">
        ...
        <a href="/homepage" class="{{ request()->is('community*') ? 'text-secondary' : 'text-white hover:text-text_gray'}} block py-2 text-lg font-poppins transition-all duration-200 ease-in-out">
            Community
        </a>

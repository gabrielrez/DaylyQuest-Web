<div id="modal" class="fixed inset-0 hidden bg-black bg-opacity-75 flex items-center justify-center">
    <div class="bg-bg_gray rounded-3xl shadow-md w-5/12 px-9 py-8">
        ...
        <p class="text-base text-text_gray">This action is permanent. Do you really want to delete your account?</p>
        <div class="flex gap-x-5 mt-10 justify-end">
            ...
            <button onclick="deleteAccount()" class="bg-error text-bg_black font-bold font-poppins text-base px-10 py-3 rounded-full shadow-md cursor-pointer hover:scale-105 transition-all duration-200 ease-in-out">Delete permanently</button>
        </div>
    </div>
</div>